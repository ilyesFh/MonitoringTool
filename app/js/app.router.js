            ...
            function($stateProvider, $urlRouterProvider, JQ_CONFIG , angularAuth0Provider) {
                ...
                .state('app.form.elements', {
					...
					*/
					...
					.state('app.tables.MaterialPreviousDay', {
                        url: '/archive_Material',
                        templateUrl: 'partials/Personal/PreviousDay_Material.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/PreviousDay_MaterialController.js',
					...
					.state('app.tables.priceValidationMikone', {
                        url: '/PriceValidation_Mikone',
                        templateUrl: 'partials/Personal/PriceValidation_RS_Other.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/PricingMDController.js',
					...
					.state('app.tables.priceValidationRSW4', {
                        url: '/PriceValidationRS_WAVE4',
                        templateUrl: 'partials/Personal/PriceValidation_RS_W4.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/PricingMDController.js',
					...
					.state('app.tables.priceValidationFS', {
                        url: '/PriceValidationFS',
                        templateUrl: 'partials/Personal/PriceValidation FS.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/PricingMDController.js',
					...
					.state('app.tables.logHistory', {
                        url: '/Logs',
                        templateUrl: 'partials/Personal/LogHistory.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/LogHistoryController.js',
					...
					.state('app.tables.LogGetDataProduction', {
                        ...
                        templateUrl: 'partials/Personal/GetData.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/GetDataController.js',
					...
					.state('app.tables.GuardRrail', {
                        url: '/Guardrail',
                        templateUrl: 'partials/Personal/GuardrailPricing.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
					...
					.state('app.tables.pricingPreviousDay', {
                        url: '/PricingArchive',
                        templateUrl: 'partials/Personal/PreviousDay_Pricing.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/PricingMDController.js',
					...
					.state('app.tables.shipmentIdocs', {
                        url: '/Shipment',
                        templateUrl: 'partials/Personal/ShipmentIdocs.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/ShipmentController.js',
					...
					.state('app.tables.shipmentDetails', {
                        url: '/Details',
                        templateUrl: 'partials/Personal/ShipmentDetails.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/Custom/ShipmentController.js',
					...
					.state('app.tables.SettlementDetails', {
                        url: '/SettlementDetails',
                        templateUrl: 'partials/Personal/Settlement.html',
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function($ocLazyLoad) {
